...
import { POST_REVALIDATE_TIME, SEO_REVALIDATE_TIME, isSEOEnable } from './utils';
/**
 * postPathBySlug
 */
...
export async function getPostBySlug(slug) {
  ...
  try {
    postData = await getClient().query({
      ...
      context: {
        fetchOptions: {
          next: { revalidate: POST_REVALIDATE_TIME },
        },
      },
    });
  } catch (e) {
